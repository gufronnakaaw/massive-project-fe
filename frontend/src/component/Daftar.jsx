  ...
  async function handleRegister() {
    try {
      const result = await axios.post(
        'http://localhost:7539/api/auth/register',
        {
          ...input,
        }
      );
        ...
        <div className="container text-white bg-fifth w-[1024px] flex justify-center rounded-2xl">
          <div className="flex items-center">
            <div className="p-16 md:flex-1 md:ps-11 md:p-0">
              ...
              <h1 className="font-bold text-white text-4xl text-center md:text-5xl md:text-start">
                DAFTAR SEKARANG
              </h1>
            ...
            <div className="hidden md:flex-1 md:ps-10 md:block">
              <img
                src="/images/imgdaftar.png"
                alt=""
                className="rounded-l-[50px] rounded-2xl"
              />
            </div>
          </div>
        </div>
